...
class AlarmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post alarms_url, params: { alarm: { is_active: @alarm.is_active, repeat: @alarm.repeat, time: @alarm.time } }
    end
  ...
  test "should update alarm" do
    patch alarm_url(@alarm), params: { alarm: { is_active: @alarm.is_active, repeat: @alarm.repeat, time: @alarm.time } }
